...
bool CMaterialManager::Init()
{
	...
	for (int i = 0; i <= 379; ++i)
	{
		...
		wsprintf(FileName, TEXT("Tile/Tile1.png"), i);
		//wsprintf(FileName, TEXT("TransparentTile.png"), i);
		//wsprintf(FileName, TEXT("DefaultDistortionNormal.png"), i); //1127
		//wsprintf(FileName, TEXT("Tile/Tile%d.png"), i); 
