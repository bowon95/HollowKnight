...
void CLoadingSceneInfo::SceneChangeComplete()
{
	...
	//m_LoadingThread->SetLoadingSceneFileName("test12.scn"); // 에디터로 저장한거 불러오기
	...
	//CSceneManager::GetInst()->GetNextScene()->Load("LoadingUI");
	//CSceneManager::GetInst()->GetNextScene()->Load("StartSceneUI");

	//CSceneManager::GetInst()->GetNextScene()->Load("test11"); // 직접 만든 클래스 불러오기. 로딩창 사라짐
}
